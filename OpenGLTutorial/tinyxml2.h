...
static const int TIXML2_min_OR_VERSION = 1;
...
/**
	...
	Assumin_g you want the value of "attributeB" in the 2nd "Child" element, it's very
...
/**
	...
	for streamin_g, and constructing the DOM is just overhead.

	The Printer supports the streamin_g case. The following code
...
public:
    ...
    */
    ...
    /** If streamin_g, write the BOM and declaration. */
    void PushHeader( bool writeBOM, bool writeDeclaration );
    /** If streamin_g, start writing an element.
        The element must be closed with CloseElement()
    */
    void OpenElement( const char* name, bool compactMode=false );
    /// If streamin_g, add an attribute to an open element.
    void PushAttribute( const char* name, const char* value );
    void PushAttribute( const char* name, int value );
    void PushAttribute( const char* name, unsigned value );
    void PushAttribute( const char* name, bool value );
    void PushAttribute( const char* name, double value );
    /// If streamin_g, close the Element.
    ...
    */
    ...
    /**
    	...
    	includes the termin_ating null.)
    */
    int CStrSize() const {
        return _buffer.Size();
    }
